...
- **Document Translation**: Upload PDF or Word (.docx) files for automatic text extraction and translation.
...
- **Vanilla CSS**: Custom design system with modern effects.
- **JavaScript (ES6+)**: Logic for speech recognition and API integration.
- **Web Speech API**: High-performance voice-to-text.
- **MyMemory API**: Reliable translation engine.

## 💻 How to Use

1. **Clone the repository**:
   ```bash
   git clone https://github.com/animusehsan-sketch/translation-app.git
   ```
